...
```{r}
product3 <- read_excel("Homework3_data.xlsx", 
                       sheet = "Product3")
...
- Region1: Daily demand for Product 3 in Regional Distribution Center 1.
- Region2: Daily demand for Product 3 in Regional Distribution Center 2.
- Region3: Daily demand for Product 3 in Regional Distribution Center 3.
- Region4: Daily demand for Product 3 in Regional Distribution Center 4.
...
D_region1 <- mean(product3$Region1)
D_region2 <- mean(product3$Region2)
D_region3 <- mean(product3$Region3)
D_region4 <- mean(product3$Region4)
...
sigma_region1 <- sd(product3$Region1)
sigma_region2 <- sd(product3$Region2)
sigma_region3 <- sd(product3$Region3)
sigma_region4 <- sd(product3$Region4)
...
D_national <- mean(c(product3$Region1, product3$Region2, product3$Region3, product3$Region4))
sigma_national <- sd(c(product3$Region1, product3$Region2, product3$Region3, product3$Region4))
...
In conclusion, for Product 3, Same as Product 1 & Product 2, using regional distribution centers is more cost-effective than consolidating into a national distribution center. The significantly higher transportation costs associated with the national distribution center outweigh any potential savings in other areas, leading to a higher total daily cost. Therefore, it is wiser to continue with the regional distribution centers to optimize cost efficiency for Product 3.
